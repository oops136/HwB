...
LANG_CONTENT[LANG_EN] = {
    BTM_INFO: "updates provided by regen@nuke.africa",
    CONFIG_FUNCTION_TITLE: "Functions",
    NOT_REGULAR_PAGE: "HwB: running nothing. This is not a regular game page",
    CONTROL_PANEL_TITLE: "HwB",
    ...
    TRANSFER_TO_BTC: "Transfer money from missions to the connected BTC wallet",
    ...
    SECONDS: "seconds",
    WEBCRAWLER_INITIAL_HOSTS: "starting with:",
    WEBCRAWLER_IGNORE_HOSTS: "Ignored IPs:",
    ...
    CREDITS_r4: "removing external connections (fucking rats) and updating bot.",
