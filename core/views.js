var views = {
	appendControlPanel: function(controller){		
		...
		var selectIpList =  `
			<select id="${FIELD_BANK_IP_TARGET}" style="vertical-align: initial; margin-left: 10px; margin-right: 10px; width: 26%">
			</select>
		`;
		divMain.innerHTML =
			...
			'</div>' +
			'<div id="' + MAIN_SCREEN_DOM_ID + '" class="modal-body" style="max-height:600px">' +
				...
				'<br /><br />' +
				'<button id="' + PERFORM_BANK_CAMPING + '" class="btn-xs btn-info">' + LANG.INTERCEPT_TRANSACTIONS + '</button>' + selectIpList +
				...
				'<tr class="secondary"><td>' +
				'<button id="' + SET_SEARCH_FOR_IPS + '" class="btn-xs btn-info">' + LANG.RUN_WEBCRAWLER + '</button> ' + LANG.WEBCRAWLER_INITIAL_HOSTS + '<input id="' + FIELD_IPS_START_SEARCHING + '" class="controls fieldsContent" placeholder="' + LANG.PASTE_IPS + '" type="text" style="vertical-align: initial; margin-left: 10px; margin-right: 10px; width:35%">' + 
	            '</td></tr>' +
				'<tr class="secondary"><td>' +
				'<input type="checkbox" class="checkBoxes" id="' + SET_IGNORE_LIST + '" <span style="margin-bottom:5px;"><span style="margin-left:4px;">' + LANG.WEBCRAWLER_IGNORE_HOSTS + '</span><input id="' + FIELD_HOSTS_TO_IGNORE + '" class="controls fieldsContent" placeholder="' + LANG.PASTE_IPS + '" type="text" style="vertical-align: initial; margin-left: 10px; margin-right: 10px; width:35%"></label>' +
	            '</td></tr>' +
			...
			'<div id="' + CREDITS_SCREEN_DOM_ID + '" class="modal-body">' +
				...
				'<a href="https://github.com/oops136">R4G3N</a> - ' + LANG.CREDITS_r4 + '<br />' +
			...
			'<div id="' + CONFIG_PANEL + '" class="modal-body" style="max-height:405px">' +
				...
				'<div class="section-title">'+
					...
					'<div class="divider">'+
						...
						//'<label><input class="checkBoxes" style="margin:0;" id="' + SET_HIDE_MODE + '"type="checkbox"><span style="margin-left:4px;">' + LANG.WEBCRAWLER_HIDE_UPLOAD + '</span></label>' +
